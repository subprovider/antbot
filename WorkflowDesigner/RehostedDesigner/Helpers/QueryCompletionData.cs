...
namespace ktds.AntBot.Studio.Helpers
{
    public class QueryCompletionData : ICompletionData
    {
        ...
        {
            return BitmapFrame.Create(typeof(QueryCompletionData).Assembly.GetManifestResourceStream("ktds.AntBot.Studio.Resources.ExpressionEditor." + resourceName));
        }
